...
# Introduction to complex covariate structures in **GHRmodel**
...
## Overview of **GHRmodel** helper functions for writing INLA-compatible formulas
...
# Example 1: Complex covariate structures in **GHRmodel** using helper functions

## 1. Model development using **GHRmodel** helper functions
...
glimpse(cov_names)
#>  chr [1:14] "tmin.l1" "tmin.l2" "tmin.l3" "tmin.l4" "tmin.l5" "tmin.l6" "pdsi.l1" "pdsi.l2" "pdsi.l3" ...
```
...
### List of nonlinear covariates replicated by group
...
### List of covariates for multivariate models
...
containing “tmin” and “pdsi” listed in the `uni_cov_nl_rep` object where
...
### List of interacting covariates
...
#> [[1]]
#> [1] "pdsi.l1"               "tmin.l1"               "urban"                 "pdsi.l1:tmin.l1"      
#> [5] "pdsi.l1:urban"         "tmin.l1:urban"         "pdsi.l1:tmin.l1:urban"
#> 
#> [[2]]
#> [1] "pdsi.l2"               "tmin.l1"               "urban"                 "pdsi.l2:tmin.l1"      
#> [5] "pdsi.l2:urban"         "tmin.l1:urban"         "pdsi.l2:tmin.l1:urban"
```

### List of varying covariates
...
pairing climate zone–specific lagged *pdsi* variables with linear lagged
*tmin*:
...
## 2. Model fitting from a list of covariates
...
## 3. Model evaluation: effects of complex covariate structures
...
<img src="GHRmodel_covariates_files/figure-gfm/plot interactions-1.png" width="100%" style="display: block; margin: auto;" />

### Varying linear coefficients

The `plot_coef_varying()` function generates a forest plot that
visualizes varying coefficients — often referred to as random slopes —
...
Here we show the four major Köppen-Geiger climate regimes, the letter
...
Main Köppen-Geiger Climate Regimes used in the varying coefficient
analysis
...
plot_coef_varying(
  ...
  name = "main_climate_f",               # The grouping variable (factor) for which varying slopes were estimated
...
covariate–model combination, with effects in columns and models in rows.
...
plot_coef_nl(
  ...
  title = "nonlinear effect of PDSI at one-month lag replicated by main climate",   # Main plot title
...
# Example 2: Modeling in GHRmodel with user-defined INLA-compatible formulas
...
<img src="GHRmodel_covariates_files/figure-gfm/plot user model-1.png" width="100%" style="display: block; margin: auto;" />
