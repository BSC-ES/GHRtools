---
title: "Distributed Lag Nonlinear Models"
format: 
  html:
    toc: true
---
...
```{=html}
<img src="/figures/GHRmodel.svg" align="right" width="14%" style="margin-top: -50px; style="margin-top: 0px;>
```
...
> 💡 **Tip**: The examples in this vignette are designed to demonstrate
...
<img src="GHRmodel_DLNM_files/figure-gfm/Plot coefficients for cb_tmin slices by temp values-1.png" style="display: block; margin: auto;" />
<br>
